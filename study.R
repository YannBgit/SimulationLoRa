...
# A RAJOUTER SUR DES FIGURES SEPAREES : Courbe de la probabilité de collision moyenne (moyenne sur les 7 états d'émission) en fonction
# du nombre de capteurs dans le réseau (de 1 à 100)